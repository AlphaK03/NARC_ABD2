...
CREATE OR REPLACE DIRECTORY RMAN_DIR AS 'C:\Oracle21c\rman_app';
--GRANT READ, WRITE ON DIRECTORY RMAN_DIR TO CRAN_CLIENT2; 
 -- ajusta APPUSER a tu usuario real
...
CREATE TABLE BK_STRATEGY (
  ...
  name_code         VARCHAR2(128) NOT NULL,  
...
CREATE TABLE BK_SCHEDULE (
  ...
  byday             VARCHAR2(50),            
   -- MON,TUE,... (solo para WEEKLY)
  byhour            VARCHAR2(50),           
    -- "2" o "2,14"
  byminute          VARCHAR2(50),           
    -- "0" o "0,30"
...
CREATE TABLE BK_LOG (
  ...
  strategy_id       NUMBER NOT NULL,
  run_id            VARCHAR2(64),            
   -- DBMS_SCHEDULER run_id (cuando aplique)
  started_at        TIMESTAMP,
  finished_at       TIMESTAMP,
  status            VARCHAR2(20),            
   -- SUCCESS|FAILED|WARNING|SUBMITTED
  message           CLOB,
  created_at        TIMESTAMP DEFAULT SYSTIMESTAMP,
